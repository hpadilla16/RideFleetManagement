...
/// Utilería compartida de los tests de auth (H1).
...
/// AuthResponse desde el fixture, con token vivo y mustChangePassword a
/// gusto del test.
AuthResponse authResponseFromFixture({
  ...
  (raw['user'] as Map<String, dynamic>)['mustChangePassword'] =
      mustChangePassword;
