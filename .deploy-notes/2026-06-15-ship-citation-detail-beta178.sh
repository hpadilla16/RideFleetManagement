#!/usr/bin/env bash
# v0.9.0-beta.178 — Citations: profile/detalle + lista mejorada + pay link
#   bash .deploy-notes/2026-06-15-ship-citation-detail-beta178.sh
#
...
#   .deploy-notes/2026-06-15-ship-citation-detail-beta178.sh
set -euo pipefail
