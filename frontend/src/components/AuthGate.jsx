...
import { mirrorAuthToNative, rehydrateAuthFromNative, startNativeAuthBridge } from '../lib/nativeShell';
...
export function AuthGate({ children }) {
  ...
  useEffect(() => {
    ...
    // Native shell: WKWebView may have evicted localStorage — restore the
    // session from native storage BEFORE reading it. Instant no-op on the web.
    rehydrateAuthFromNative().finally(() => {
